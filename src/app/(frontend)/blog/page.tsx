...
export default async function Page() {
  ...
  return (
    <div className="pb-28 pt-10 md:pt-14">
      <PageClient />
      {/* The main site's blog header, copy and all (its BlogPage.tsx). */}
      <div className="container mb-12">
        <p className="text-xs tracking-[0.2em] uppercase text-muted-foreground mb-3">
          Kennisbank
        </p>
        <h1 className="editorial-heading text-3xl sm:text-4xl text-foreground mb-3">
          Blog &amp; Voedingswetenschap
        </h1>
        <p className="text-muted-foreground max-w-2xl leading-relaxed">
          Expertartikelen over voeding, gezondheid, duurzaamheid en praktische tips voor een
