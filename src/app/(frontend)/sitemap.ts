 ...
 * to stumble across a link. Served at heelvrijeten.nl/blog-sitemap.xml, via
 ...
 * heelvrijeten.nl/sitemap.xml. robots.txt points at both.
 */
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // to '', so it emitted heelvrijeten.nl/<slug> — URLs Netlify does not
